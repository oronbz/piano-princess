...
import { Music, Star, Trophy, Check, Sparkles, Flame, Heart, Crown, Lock, Wand2, BookOpen, Smile } from 'lucide-react';
...
export default function App() {
  ...
  // --- Auto-Fix for Styling (Tailwind Injection) ---
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-pink-50 font-sans selection:bg-pink-200" dir="rtl">
      <style>{`
        @keyframes fall {
      ...
      <div className="max-w-md mx-auto min-h-screen relative flex flex-col pb-24">
        ...
        {/* Header Section */}
        <div className="pt-8 pb-12 px-6 bg-gradient-to-b from-pink-400 to-pink-200 rounded-b-[40px] shadow-lg relative overflow-hidden">
      ...
      {/* Footer / Nav */}
      <div className="fixed bottom-0 w-full bg-white/95 backdrop-blur-xl border-t border-pink-100 py-2 pb-8 flex justify-around text-gray-400 max-w-md left-1/2 transform -translate-x-1/2 z-40 rounded-t-3xl shadow-[0_-5px_20px_rgba(0,0,0,0.05)] px-2">
         <button 
